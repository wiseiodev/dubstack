...
export async function aiReviewBranch(
  ...
  const prompt = [
    ...
    '- Check PR description completeness and TODO/TBD/FIXME placeholders only when an open PR description is present.',
    '- Do not report a missing PR description when this says no open PR description was found; this command often runs before submit.',
